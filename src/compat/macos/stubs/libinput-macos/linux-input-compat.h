...
// macOS compatibility for linux/input.h
#include <stdint.h>
#include <sys/types.h>
#include <sys/time.h>

// Basic input event types
#define EV_SYN 0x00
#define EV_KEY 0x01
#define EV_REL 0x02
#define EV_ABS 0x03
...
// Key codes - Complete set from Linux input-event-codes.h
...
// Only define if libinput headers haven't already defined it
struct input_event {
    struct timeval time;
    uint16_t type;
    uint16_t code;
